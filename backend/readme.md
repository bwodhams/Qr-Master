...
| POST | {HOST}/api/user/login | Login to account | Body containing email, inputPassword | JSON object {"message": "someMessage", "loggedIn": true or false, "loginAuthToken": "1234", "name": "account name"} | /api/user/login  with request body of {"email": "random@gmail.com", "inputPassword": "randomPassword"} |
