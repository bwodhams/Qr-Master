...
| PUT | {HOST}/api/user/create | Create new account with email, passwordHash and name, inputted by the user. | Body containing email, name, password | /api/create  body of {"email": "random@gmail.com", "name": "Random Name", "passwordHash": "randomPassword"} |